...
// -------------- Rotas Protegidas - com auth do usuario --------------- //

const authUserMid = UsuarioMiddleware(repositorioUsuario)

const obterProdutoPorId = new ObterProdutoPorId()
new ObterProdutoPorIdController(app, obterProdutoPorId, authUserMid)